...
<body>
<h2 align="center">Update User Data</h2>
<p align="center">${updatemessage}</p>
...
<div class="input-box">
  ...
  <div class="input-box">
   ...
   <input id="mobile" name="phoneNumber" type="text" pattern="[6-9]\d{9}" title="Enter a valid mobile number."
    value="${userKey.phoneNumber}">
